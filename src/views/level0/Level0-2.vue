<template>
  <div class="layout-vertical">
    ...
    <img class="level-image" src="@/assets/level_0_img_1.jpg" alt="intro image 1" />
    <p class="level-text">
      Walking through the bustling pre-apocalyptic city, you are awed by the unanticipated warmth of
      sunshine and catch a glimpse of yourself in a store window. A cheery woman with a definitive
    ...
    <p class="level-text mt-1">
      ...
      throughout the concentric spheres of human interaction worldwide regardless of class or access.
    </p>
    ...
    <p class="level-text mt1">
      ...
      that is intimately connected to the shared resource... <br /><strong
